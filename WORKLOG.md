...
**P1.14 verification method, for anyone auditing:** every factual statement in the six checklists was checked against a primary source before writing — Rules Governing 2255 Proceedings (Rules 2–8) and 2254 Cases (Rules 2–3) from uscode.house.gov; 28 U.S.C. § 1914(a) verbatim; 18 U.S.C. § 3582(c)(1)(A) exhaustion clause verbatim; 28 C.F.R. §§ 542.13–.18 pulled from govinfo because eCFR blocks automated requests; PACER fees from the Electronic Public Access Fee Schedule. All 17 authority URLs on the new pages were resolved (HTTP 200; CourtListener returns 202 to automated clients, and those three clusters were separately confirmed through the API). **No government form was recreated, reformatted or paraphrased** — the checklists are original content about the forms and link the official PDFs already served from /forms/.

**Correction applied during review, recorded rather than quietly fixed.** The first draft of the PACER guide asserted that "by the judiciary's own figures, most PACER users pay nothing in a given quarter." On re-reading before push, that sentence was checked against the Electronic Public Access Fee Schedule it implicitly cited, and the page contains no such figure — no percentage, no "most users" statement. The claim was removed rather than back-filled with a citation found afterward. The four hard numbers around it were confirmed verbatim: $0.10 per page; capped at the fee for thirty pages; no fee owed until an account accrues more than $30.00 in a quarterly billing cycle; no fee for judicial opinions. This is the exact failure mode the verify-before-writing rule exists to catch, and it got through the drafting pass.
